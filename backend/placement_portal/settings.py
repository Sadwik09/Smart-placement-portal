...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-mh@o#^gj1wk0*qh=t%=#&yjrb&n@6pdatsyb1#fr29yb+=3i0g')
...
# Sentry Configuration (optional - only if DSN is set)
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'no-reply@smartplacement.local')
EMAIL_VERIFICATION_BASE_URL = os.environ.get('EMAIL_VERIFICATION_BASE_URL', 'http://localhost:3000/verify-email')
PASSWORD_RESET_BASE_URL = os.environ.get('PASSWORD_RESET_BASE_URL', 'http://localhost:3000/password-reset-confirm')
...
# Sentry is configured at the top of this file
